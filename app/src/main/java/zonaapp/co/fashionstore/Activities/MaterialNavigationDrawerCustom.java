...
/**
 * Created by servintesas on 6/12/15.
 */
public abstract class MaterialNavigationDrawerCustom<Fragment> extends ActionBarActivity implements MaterialSectionListener,MaterialAccount.OnAccountDataLoaded {
        ...
        public void onClick(View v) {
            if(!drawerTouchLocked) {
                ...
                if (!accountSwitcher) {
                    ...
                    userButtonSwitcher.setImageResource(it.neokree.materialnavigationdrawer.R.drawable.ic_arrow_drop_up_white_24dp);
                    ...
                    for (MaterialAccount account : accountManager) {
                        ...
                        if(account.getAccountNumber() != MaterialAccount.FIRST_ACCOUNT) {
                            ...
                            sections.addView(account.getSectionView(MaterialNavigationDrawerCustom.this, fontManager.getRobotoMedium(),accountSectionListener,rippleSupport,account.getAccountNumber()),params);
                        }
                    }
                    ...
                    userButtonSwitcher.setImageResource(it.neokree.materialnavigationdrawer.R.drawable.ic_arrow_drop_down_white_24dp);
                    ...
                    for(Element element : elementsList) {
                        switch(element.getType()) {
                            ...
                            case Element.TYPE_DIVISOR:
                                View view = new View(MaterialNavigationDrawerCustom.this);
                    ...
                    View divisor = new View(MaterialNavigationDrawerCustom.this);
                    divisor.setBackgroundColor(Color.parseColor("#8f8f8f"));

                    // si aggiungono le bottom sections
                    if (heightDrawer >= Utils.getScreenHeight(MaterialNavigationDrawerCustom.this)) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        theme.resolveAttribute(it.neokree.materialnavigationdrawer.R.attr.learningPattern,typedValue,false);
        learningPattern = typedValue.data != 0;
        theme.resolveAttribute(it.neokree.materialnavigationdrawer.R.attr.drawerColor,typedValue,true);
        drawerColor = typedValue.data;
        theme.resolveAttribute(it.neokree.materialnavigationdrawer.R.attr.defaultSectionLoaded,typedValue,true);
        defaultSectionLoaded = typedValue.data;
        theme.resolveAttribute(it.neokree.materialnavigationdrawer.R.attr.toolbarElevation, typedValue, false);
        toolbarElevation = typedValue.data != 0;

        if(drawerHeaderType == DRAWERHEADER_ACCOUNTS)
            super.setContentView(it.neokree.materialnavigationdrawer.R.layout.activity_material_navigation_drawer);
        else
            super.setContentView(it.neokree.materialnavigationdrawer.R.layout.activity_material_navigation_drawer_customheader);

        // init Typeface
        fontManager = new TypefaceManager(this.getAssets());

        // init toolbar & status bar
        statusBar = (ImageView) findViewById(it.neokree.materialnavigationdrawer.R.id.statusBar);
        toolbar = (Toolbar) findViewById(it.neokree.materialnavigationdrawer.R.id.toolbar);

        // init drawer components
        layout = (MaterialDrawerLayout) this.findViewById(it.neokree.materialnavigationdrawer.R.id.drawer_layout);
        content = (RelativeLayout) this.findViewById(it.neokree.materialnavigationdrawer.R.id.content);
        drawer = (RelativeLayout) this.findViewById(it.neokree.materialnavigationdrawer.R.id.drawer);
        if(drawerHeaderType == DRAWERHEADER_ACCOUNTS) {
            username = (TextView) this.findViewById(it.neokree.materialnavigationdrawer.R.id.user_nome);
            usermail = (TextView) this.findViewById(it.neokree.materialnavigationdrawer.R.id.user_email);
            userphoto = (ImageView) this.findViewById(it.neokree.materialnavigationdrawer.R.id.user_photo);
            userSecondPhoto = (ImageView) this.findViewById(it.neokree.materialnavigationdrawer.R.id.user_photo_2);
            userThirdPhoto = (ImageView) this.findViewById(it.neokree.materialnavigationdrawer.R.id.user_photo_3);
            usercover = (ImageView) this.findViewById(it.neokree.materialnavigationdrawer.R.id.user_cover);
            usercoverSwitcher = (ImageView) this.findViewById(it.neokree.materialnavigationdrawer.R.id.user_cover_switcher);
            userButtonSwitcher = (ImageButton) this.findViewById(it.neokree.materialnavigationdrawer.R.id.user_switcher);
            ...
            theme.resolveAttribute(it.neokree.materialnavigationdrawer.R.attr.accountStyle,typedValue,true);
            TypedArray attributes = theme.obtainStyledAttributes(typedValue.resourceId, it.neokree.materialnavigationdrawer.R.styleable.MaterialAccount);
            try {
                username.setTextColor(attributes.getColor(it.neokree.materialnavigationdrawer.R.styleable.MaterialAccount_titleColor,0xFFF));
                usermail.setTextColor(attributes.getColor(it.neokree.materialnavigationdrawer.R.styleable.MaterialAccount_subtitleColor,0xFFF));
            }
            finally {
                attributes.recycle();
            }
            ...
            customDrawerHeader = (LinearLayout) this.findViewById(it.neokree.materialnavigationdrawer.R.id.drawer_header);
        sections = (LinearLayout) this.findViewById(it.neokree.materialnavigationdrawer.R.id.sections);
        bottomSections = (LinearLayout) this.findViewById(it.neokree.materialnavigationdrawer.R.id.bottom_sections);
        ...
        // get primary color
        theme.resolveAttribute(it.neokree.materialnavigationdrawer.R.attr.colorPrimary, typedValue, true);
        primaryColor = typedValue.data;
        theme.resolveAttribute(it.neokree.materialnavigationdrawer.R.attr.colorPrimaryDark, typedValue, true);
        ...
        if(Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT) {
            ...
            if(kitkatTraslucentStatusbar) {
                ...
                RelativeLayout.LayoutParams statusParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, resources.getDimensionPixelSize(it.neokree.materialnavigationdrawer.R.dimen.traslucentStatusMargin));
                ...
                if(drawerHeaderType == DRAWERHEADER_ACCOUNTS) {
                    ...
                    photoParams.setMargins((int) (16 * density), resources.getDimensionPixelSize(it.neokree.materialnavigationdrawer.R.dimen.traslucentPhotoMarginTop), 0, 0);
        ...
        if (toolbarElevation) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                View elevation = LayoutInflater.from(this).inflate(it.neokree.materialnavigationdrawer.R.layout.layout_toolbar_elevation,content, false);
        ...
        if(deviceSupportMultiPane()) {
            ...
            pulsante = new MaterialActionBarDrawerToggle<Fragment>(this,layout,toolbar, it.neokree.materialnavigationdrawer.R.string.nothing, it.neokree.materialnavigationdrawer.R.string.nothing) {
    ...
    private void setFragment(Fragment fragment,String title,Fragment oldFragment,boolean hasSavedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
            ...
            if(!hasSavedInstanceState) {// se non e' avvenuta una rotazione
                ...
                ft.replace(it.neokree.materialnavigationdrawer.R.id.frame_container, (android.app.Fragment) fragment).commit();
            }
        }
