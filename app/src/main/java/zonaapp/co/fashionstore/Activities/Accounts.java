...
import zonaapp.co.fashionstore.Fragments.FragmentAcercade;
import zonaapp.co.fashionstore.Fragments.FragmentAyuda;
...
public class Accounts extends MaterialNavigationDrawerCustom  {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        this.addSection(newSection("Soporte/Contacto", R.drawable.ic_person_pin_black_24dp, new FragmentAyuda()));
        this.addSection(newSection("Acerca de", R.drawable.ic_people_black_24dp, new FragmentAcercade()));
